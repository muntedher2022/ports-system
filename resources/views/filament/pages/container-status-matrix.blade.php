    ...
    <div class="cs-dashboard">
        ...
        <div class="cs-filter-bar">
            ...
            <div class="cs-filter-left">
                ...
                <button wire:click="$set('selectedContainerType','abandoned')"
                    class="cs-type-btn abandoned {{ $this->selectedContainerType === 'abandoned' ? 'active' : '' }}">
                    📦 متخلفة
                </button>
                <button wire:click="$set('selectedContainerType','dangerous')"
                    class="cs-type-btn dangerous {{ $this->selectedContainerType === 'dangerous' ? 'active' : '' }}">
                    ⚠️ خطرة
                </button>
            ...
            <div class="cs-filter-right">
                <a href="{{ route('admin.containers.export-excel', [
        ...
        <div class="cs-card">
            <div class="cs-card-header">
                <h3>📋 موقف {{ $typeLabel }} لغاية شهر {{ $monthLabel }} لسنة {{ $yearLabel }}</h3>
            </div>
