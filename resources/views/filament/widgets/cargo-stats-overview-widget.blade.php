<x-filament-widgets::widget>
    ...
    <div class="gcpi-cargo-widget-wrapper">
        <div class="gcpi-cargo-section-title">
            <h3>
                <span>📦</span>
                <span>موقف المواد والبضائع المتخلفة والخطرة (سنة {{ $stats['currentYear'] }})</span>
            </h3>
            <a href="{{ url('/admin/cargo-status-matrix') }}" class="text-xs font-bold text-blue-600 hover:text-blue-800 flex items-center gap-1">
        ...
        <div class="gcpi-cargo-stats-row">
            ...
            <a href="{{ url('/admin/cargo-status-matrix?type=abandoned') }}" class="gcpi-cargo-card cargo-card-amber">
                ...
                <div class="text-lg font-extrabold text-gray-900 mb-1 font-mono">
                    {{ number_format($stats['abandonedTotal']) }} <span class="text-xs font-normal text-gray-500">طرد/مادة</span>
                </div>
            ...
            <a href="{{ url('/admin/cargo-status-matrix?type=dangerous') }}" class="gcpi-cargo-card cargo-card-rose">
                <div class="flex items-center justify-between mb-1.5">
                ...
                <div class="text-lg font-extrabold text-rose-700 mb-1 font-mono">
                    {{ number_format($stats['dangerousTotal']) }} <span class="text-xs font-normal text-rose-500">طرد/مادة</span>
                </div>
            ...
            <div class="gcpi-cargo-card cargo-card-cyan">
                ...
                <div class="text-[0.72rem] text-cyan-600 font-semibold">
                    <span>إجمالي الرصيد: {{ number_format($stats['topPortCount']) }} طرد/مادة</span>
                </div>
            </div>

            <!-- 4. عدد الجهات والوزارات المسجلة -->
            <a href="{{ url('/admin/cargo-entities') }}" class="gcpi-cargo-card cargo-card-emerald">
                <div class="flex items-center justify-between mb-1.5">
                ...
                <div class="text-lg font-extrabold text-emerald-900 mb-1 font-mono">
                    {{ number_format($stats['entitiesCount']) }} <span class="text-xs font-normal text-emerald-600">جهة / قطاع</span>
                </div>
