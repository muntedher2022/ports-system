    ...
    <div class="gcpi-dashboard">
        ...
        <div class="gcpi-filter-bar">
            ...
            <div class="gcpi-filter-item">
                ...
                <select wire:model.live="selectedFiscalYearId" class="gcpi-select">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $d['fiscalYears']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fy): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <option value="<?php echo e($fy->id); ?>"><?php echo e($fy->year); ?> <?php echo e($fy->is_current ? '(السنة الحالية)' : ''); ?></option>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                </select>
            </div>
            ...
            <div class="gcpi-filter-item" style="justify-content: flex-end; display: flex; flex-direction: row; gap: 8px; flex-wrap: wrap;">
                <a href="<?php echo e(route('admin.reports.total-cumulative-capacity.pdf', ['fiscal_year_id' => $this->selectedFiscalYearId, 'month_number' => $this->selectedMonthNumber])); ?>" target="_blank" class="gcpi-btn-pdf" style="background: linear-gradient(135deg, #0284c7 0%, #0369a1 100%);">
                    📚 تصدير التقرير الشامل (كافة الموانئ + الإجمالي)
                </a>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->selectedPortId): ?>
                    <a href="<?php echo e(route('admin.reports.total-cumulative-capacity.pdf', ['fiscal_year_id' => $this->selectedFiscalYearId, 'month_number' => $this->selectedMonthNumber, 'port_id' => $this->selectedPortId])); ?>" target="_blank" class="gcpi-btn-pdf">
                        📄 تصدير ميناء (<?php echo e($d['selectedPort']); ?>)
                    </a>
                <?php else: ?>
                    <a href="<?php echo e(route('admin.reports.total-cumulative-capacity.pdf', ['fiscal_year_id' => $this->selectedFiscalYearId, 'month_number' => $this->selectedMonthNumber, 'only_total' => 1])); ?>" target="_blank" class="gcpi-btn-pdf">
        ...
        <div class="gcpi-metrics-grid">
            <div class="gcpi-metric-card" style="border-top: 4px solid #2563eb;">
                ...
                <span class="gcpi-metric-num" style="color: #1e3a8a;"><?php echo e(number_format($s['total_ships'])); ?> <span style="font-size: 0.8rem; color: #64748b;">باخرة</span></span>
            </div>
            <div class="gcpi-metric-card" style="border-top: 4px solid #059669;">
                ...
                <span class="gcpi-metric-num" style="color: #047857;"><?php echo e(number_format(round($s['total_tonnage']), 0)); ?> <span style="font-size: 0.8rem; color: #64748b;">طن</span></span>
            </div>
            <div class="gcpi-metric-card" style="border-top: 4px solid #0891b2;">
                <span class="gcpi-metric-title"><?php echo e($isAll ? 'الطاقة الإنتاجية الكلية للشركة TEU' : 'الطاقة الإنتاجية للميناء TEU'); ?></span>
                <span class="gcpi-metric-num" style="color: #0e7490;"><?php echo e(number_format($s['total_teu'])); ?> <span style="font-size: 0.8rem; color: #64748b;">TEU</span></span>
            </div>
            <div class="gcpi-metric-card" style="border-top: 4px solid #d97706;">
                <span class="gcpi-metric-title"><?php echo e($isAll ? 'إيراد الموانئ الأربعة فقط' : 'الإيراد الكلي للميناء'); ?></span>
                <span class="gcpi-metric-num" style="color: #b45309; font-size: 1.15rem;"><?php echo e(number_format($s['total_revenue'], 0)); ?> <span style="font-size: 0.75rem; color: #64748b;">د.ع</span></span>
            </div>
        </div>
        ...
        <div class="gcpi-card">
            <div class="gcpi-card-header">
                <div>
                    <h2>اجمالي الطاقة الانتاجية (<?php echo e($d['selectedPort']); ?>)</h2>
                    <div style="font-size: 0.85rem; opacity: 0.9; margin-top: 4px;">
                        للفترة من 1 / 1 / <?php echo e($d['selectedYear']); ?> لغاية نهاية شهر <?php echo e($d['selectedMonth']); ?> <?php echo e($d['selectedYear']); ?>
                ...
                <table class="gcpi-table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="text-align: center;" class="gcpi-val-highlight" style="color: #1e3a8a;"><?php echo e(number_format($s['total_ships'])); ?></td>
                            <td style="text-align: center;"><span class="gcpi-unit-badge">باخرة</span></td>
                        </tr>

                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$isAll): ?>
                            <tr style="background-color: #f0fdf4;">
                                ...
                                <td style="text-align: center;" class="gcpi-val-highlight" style="color: #059669;"><?php echo e(number_format(round($s['total_tonnage']), 0)); ?></td>
                                <td style="text-align: center;"><span class="gcpi-unit-badge" style="background: #d1fae5; color: #065f46;">طن</span></td>
                            </tr>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                        <tr>
                            <td style="text-align: center; color: #64748b; font-weight: bold;"><?php echo e($isAll ? 2 : 3); ?></td>
                            <td style="font-weight: 700;">معدل الاوزان الشهري</td>
                            <td style="text-align: center; font-weight: 700; color: #334155;"><?php echo e(number_format(round($s['monthly_average_weight']), 0)); ?></td>
                            <td style="text-align: center;"><span class="gcpi-unit-badge">طن</span></td>
                        </tr>

                        <tr>
                            <td style="text-align: center; color: #64748b; font-weight: bold;"><?php echo e($isAll ? 3 : 4); ?></td>
                            <td style="font-weight: 700;">معدل الاوزان اليومي</td>
                            <td style="text-align: center; font-weight: 700; color: #334155;"><?php echo e(number_format(round($s['daily_average_weight']), 0)); ?></td>
                            <td style="text-align: center;"><span class="gcpi-unit-badge">طن</span></td>
                        </tr>

                        <tr>
                            <td style="text-align: center; color: #64748b; font-weight: bold;"><?php echo e($isAll ? 4 : 5); ?></td>
                            <td style="font-weight: 700; color: #9a3412;">تصدير مشتقات نفطية</td>
                            <td style="text-align: center; font-weight: 700; color: #c2410c;"><?php echo e(number_format(round($s['oil_exported_tons']), 0)); ?></td>
                            <td style="text-align: center;"><span class="gcpi-unit-badge">طن</span></td>
                        </tr>

                        <tr>
                            <td style="text-align: center; color: #64748b; font-weight: bold;"><?php echo e($isAll ? 5 : 6); ?></td>
                            <td style="font-weight: 700; color: #9a3412;">استيراد مشتقات نفطية</td>
                            <td style="text-align: center; font-weight: 700; color: #c2410c;"><?php echo e(number_format(round($s['oil_imported_tons']), 0)); ?></td>
                            <td style="text-align: center;"><span class="gcpi-unit-badge">طن</span></td>
                        </tr>

                        <tr>
                            <td style="text-align: center; color: #64748b; font-weight: bold;"><?php echo e($isAll ? 6 : 7); ?></td>
                            <td style="font-weight: 700; color: #0369a1;">عدد الحاويات المستوردة</td>
                            <td style="text-align: center; font-weight: 700; color: #0284c7;"><?php echo e(number_format($s['imported_containers_count'])); ?></td>
                            <td style="text-align: center;"><span class="gcpi-unit-badge">حاوية</span></td>
                        </tr>

                        <tr style="background-color: #f0f9ff;">
                            <td style="text-align: center; color: #64748b; font-weight: bold;"><?php echo e($isAll ? 7 : 8); ?></td>
                            <td style="font-weight: 800; color: #0c4a6e;">عدد الحاويات المستوردة TEU</td>
                            <td style="text-align: center;" class="gcpi-val-highlight" style="color: #0284c7;"><?php echo e(number_format($s['imported_teu'])); ?></td>
                            <td style="text-align: center;"><span class="gcpi-unit-badge" style="background: #e0f2fe; color: #0369a1;">حاوية</span></td>
                        </tr>

                        <tr>
                            <td style="text-align: center; color: #64748b; font-weight: bold;"><?php echo e($isAll ? 8 : 9); ?></td>
                            <td style="font-weight: 700; color: #4338ca;">عدد الحاويات المصدرة</td>
                            <td style="text-align: center; font-weight: 700; color: #4f46e5;"><?php echo e(number_format($s['exported_containers_count'])); ?></td>
                            <td style="text-align: center;"><span class="gcpi-unit-badge">حاوية</span></td>
                        </tr>

                        <tr style="background-color: #eef2ff;">
                            <td style="text-align: center; color: #64748b; font-weight: bold;"><?php echo e($isAll ? 9 : 10); ?></td>
                            <td style="font-weight: 800; color: #312e81;">عدد الحاويات المصدرة TEU</td>
                            <td style="text-align: center;" class="gcpi-val-highlight" style="color: #4f46e5;"><?php echo e(number_format($s['exported_teu'])); ?></td>
                            <td style="text-align: center;"><span class="gcpi-unit-badge" style="background: #e0e7ff; color: #3730a3;">حاوية</span></td>
                        </tr>

                        <tr>
                            <td style="text-align: center; color: #64748b; font-weight: bold;"><?php echo e($isAll ? 10 : 11); ?></td>
                            <td style="font-weight: 700;">عدد الحاويات المصدرة مليان</td>
                            <td style="text-align: center; font-weight: 700;"><?php echo e(number_format($s['exported_full_count'])); ?></td>
                            <td style="text-align: center;"><span class="gcpi-unit-badge">حاوية</span></td>
                        </tr>

                        <tr>
                            <td style="text-align: center; color: #64748b; font-weight: bold;"><?php echo e($isAll ? 11 : 12); ?></td>
                            <td style="font-weight: 700;">عدد الحاويات المصدرة فارغ</td>
                            <td style="text-align: center; font-weight: 700;"><?php echo e(number_format($s['exported_empty_count'])); ?></td>
                            <td style="text-align: center;"><span class="gcpi-unit-badge">حاوية</span></td>
                        </tr>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$isAll): ?>
                            <tr style="background-color: #eff6ff;">
                                ...
                                <td style="text-align: center;" class="gcpi-val-highlight" style="color: #1e3a8a;"><?php echo e(number_format($s['total_teu'])); ?></td>
                            ...
                            <tr style="background-color: #fefce8; border-top: 2px solid #fef08a;">
                                ...
                                <td style="text-align: center;" class="gcpi-val-highlight" style="color: #a16207;"><?php echo e(number_format($s['total_revenue'], 0)); ?></td>
                        ...
                        <?php else: ?>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center; font-weight: 800; color: #0f172a;"><?php echo e(number_format(round($s['total_containers_weight']), 0)); ?></td>
                                <td style="text-align: center;"><span class="gcpi-unit-badge">طن</span></td>
                            </tr>
                            <tr>
                                <td style="text-align: center; color: #64748b; font-weight: bold;">15</td>
                                <td style="font-weight: 800; color: #0f172a;">مجموع وزن البضائع</td>
                                <td style="text-align: center; font-weight: 800; color: #0f172a;"><?php echo e(number_format(round($s['total_cargo_weight']), 0)); ?></td>
                                <td style="text-align: center;"><span class="gcpi-unit-badge">طن</span></td>
                            </tr>
                            <tr>
                                ...
                                <td style="text-align: center; font-weight: 800; color: #0f172a;"><?php echo e(number_format(round($s['oil_total_tons']), 0)); ?></td>
                                <td style="text-align: center;"><span class="gcpi-unit-badge">طن</span></td>
                            </tr>
                            <tr style="background-color: #fefce8; border-top: 2px solid #fef08a;">
            ...
            <div class="gcpi-card" style="border: 2px solid #0284c7;">
                <div class="gcpi-card-header" style="background: linear-gradient(135deg, #0369a1 0%, #0c4a6e 100%);">
                    <div>
                        ...
                        <div style="font-size: 0.85rem; opacity: 0.9; margin-top: 4px;">
                            المعدلات المحسوبة على أساس الفترة المسجلة (<?php echo e($s['months_count']); ?> أشهر / <?php echo e($s['days_count']); ?> يوم)
                        </div>
                    </div>
                </div>
                    ...
                    <table class="gcpi-table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="text-align: center; font-weight: 800; color: #1e3a8a;"><?php echo e(number_format(round($s['monthly_avg_ships']), 0)); ?></td>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center; font-weight: 800; color: #1e3a8a;"><?php echo e(number_format(round($s['daily_avg_ships']), 0)); ?></td>
                            ...
                            <tr style="background-color: #f0f9ff;">
                                ...
                                <td style="text-align: center; font-weight: 800; color: #0284c7;"><?php echo e(number_format(round($s['monthly_avg_teu']), 0)); ?></td>
                            ...
                            <tr style="background-color: #f0f9ff;">
                                ...
                                <td style="text-align: center; font-weight: 800; color: #0284c7;"><?php echo e(number_format(round($s['daily_avg_teu']), 0)); ?></td>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center; font-weight: 800; color: #c2410c;"><?php echo e(number_format(round($s['monthly_avg_oil_export']), 0)); ?></td>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center; font-weight: 800; color: #c2410c;"><?php echo e(number_format(round($s['monthly_avg_oil_import']), 0)); ?></td>
                                <td style="text-align: center;"><span class="gcpi-unit-badge">طن/شهر</span></td>
                            </tr>
                            <tr>
                                ...
                                <td style="text-align: center; font-weight: 800; color: #c2410c;"><?php echo e(number_format(round($s['daily_avg_oil_export']), 0)); ?></td>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center; font-weight: 800; color: #c2410c;"><?php echo e(number_format(round($s['daily_avg_oil_import']), 0)); ?></td>
                                <td style="text-align: center;"><span class="gcpi-unit-badge">طن/يوم</span></td>
                            </tr>
                        </tbody>
                    </table>
...
<?php endif; ?>
<?php /**PATH D:\Projects\ports-system\resources\views/filament/pages/total-cumulative-capacity.blade.php ENDPATH**/ ?>