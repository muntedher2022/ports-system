    ...
    <div class="gcpi-dashboard">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6 bg-white dark:bg-gray-900 p-2 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm">
            <button 
                ...
                class="gcpi-tab-btn <?php echo e($selectedMetric === 'tonnage' ? 'active' : ''); ?>"
            >
            ...
            <button 
                ...
                class="gcpi-tab-btn <?php echo e($selectedMetric === 'revenue' ? 'active' : ''); ?>"
            >
            ...
            <button 
                ...
                class="gcpi-tab-btn <?php echo e($selectedMetric === 'ships' ? 'active' : ''); ?>"
            >
            ...
            <button 
                ...
                class="gcpi-tab-btn <?php echo e($selectedMetric === 'teu' ? 'active' : ''); ?>"
            >
        ...
        <div class="gcpi-filter-bar">
            ...
            <div class="gcpi-filter-group">
                ...
                <select wire:model.live="selectedFiscalYearId" class="gcpi-select">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $d['fiscalYears']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $y): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <option value="<?php echo e($y->id); ?>">سنة <?php echo e($y->year); ?></option>
            ...
            <!-- زر تصدير PDF -->
            <div class="gcpi-filter-group">
                <a href="<?php echo e(route('admin.reports.standard-deviation.pdf', [
        ...
        <div class="gcpi-stats-grid">
            <!-- 1. الانحراف المعياري -->
            <div class="gcpi-stat-box <?php echo e($stat['cv'] <= 15 ? 'success' : ($stat['cv'] <= 30 ? 'warning' : 'danger')); ?>">
                <div class="gcpi-stat-title">الانحراف المعياري (Standard Deviation σ)</div>
                <div class="gcpi-stat-value" style="color: #1e3a8a;">
                    ± <?php echo e(number_format($stat['std_dev'], 1)); ?> <span style="font-size: 0.75rem; font-weight: normal;"><?php echo e($unit); ?></span>
                </div>
            ...
            <div class="gcpi-stat-box blue">
                ...
                <div class="gcpi-stat-value" style="color: #0f172a;">
                    <?php echo e(number_format($stat['mean'], 1)); ?> <span style="font-size: 0.75rem; font-weight: normal;"><?php echo e($unit); ?></span>
                </div>
            ...
            <div class="gcpi-stat-box <?php echo e($stat['cv'] <= 15 ? 'success' : ($stat['cv'] <= 30 ? 'warning' : 'danger')); ?>">
                ...
                <div class="gcpi-stat-value" style="color: <?php echo e($stat['cv'] <= 15 ? '#047857' : ($stat['cv'] <= 30 ? '#d97706' : '#dc2626')); ?>;">
                    <?php echo e(number_format($stat['cv'], 1)); ?>%
                </div>
                <div class="gcpi-stat-desc">تقييم: <strong><?php echo e($stat['stability']); ?></strong></div>
            </div>
            ...
            <div class="gcpi-stat-box purple">
                ...
                <div class="gcpi-stat-value" style="font-size: 1.05rem; color: #6b21a8;">
                    <?php echo e(number_format($stat['min'], 0)); ?> — <?php echo e(number_format($stat['max'], 0)); ?>
        ...
        <div class="gcpi-card">
            <div class="gcpi-card-header">
                <div>
                    <h3>📋 مصفوفة التحليل الشهري للانحراف المعياري — <?php echo e($metricTitle); ?></h3>
                ...
                <table class="gcpi-table">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 22%;">القيمة الفعلية (<?php echo e($unit); ?>)</th>
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $d['monthlyRows']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <tr>
                                <td style="text-align: right; font-weight: 800;"><?php echo e($r['month_name']); ?></td>
                                <td style="font-weight: 800; font-family: monospace;">
                                    <?php echo e($r['val'] > 0 ? number_format($r['val'], 0) : '—'); ?>

                                </td>
                                <td style="font-family: monospace; font-weight: 700;">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($r['val'] > 0): ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($r['deviation'] > 0): ?>
                                            <span style="color: #047857;" dir="ltr">+<?php echo e(number_format($r['deviation'], 0)); ?></span>
                                        <?php elseif($r['deviation'] < 0): ?>
                                            <span style="color: #b91c1c;" dir="ltr"><?php echo e(number_format($r['deviation'], 0)); ?></span>
                                        <?php else: ?>
                                            <span>0</span>
                                ...
                                <td style="font-family: monospace; font-weight: 700;">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($r['val'] > 0): ?>
                                        <span dir="ltr"><?php echo e(($r['z_score'] > 0 ? '+' : '') . number_format($r['z_score'], 2)); ?> σ</span>
                                    <?php else: ?>
                                        <span class="text-gray-400">—</span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </td>
                                <td>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($r['assessment_type'] === 'high'): ?>
                                        <span class="badge-stat-high">▲ <?php echo e($r['assessment']); ?></span>
                                    <?php elseif($r['assessment_type'] === 'normal'): ?>
                                        <span class="badge-stat-normal">● <?php echo e($r['assessment']); ?></span>
                                    <?php elseif($r['assessment_type'] === 'low'): ?>
                                        <span class="badge-stat-low">▼ <?php echo e($r['assessment']); ?></span>
                                    <?php else: ?>
        ...
        <div class="gcpi-card" style="border: 2px solid #3b82f6; box-shadow: 0 10px 30px -5px rgba(59, 130, 246, 0.1);">
            ...
            <div style="padding: 24px; background: #f8fafc;">
                ...
                <div style="background: #ffffff; border-radius: 14px; border: 1.5px solid #cbd5e1; padding: 18px 20px; box-shadow: 0 2px 8px rgba(0,0,0,0.02);">
                    <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 10px; margin-bottom: 14px; border-bottom: 1.5px solid #e2e8f0; padding-bottom: 10px;">
                        <div style="display: flex; align-items: center; gap: 8px;">
                            ...
                            <h4 style="margin: 0; font-size: 1.05rem; font-weight: 800; color: #0f172a;">
                                مصفوفة المعالجة المخصصة لمؤشر: <span style="color: #1e3a8a;"><?php echo e($metricTitle); ?></span>
                            </h4>
                        </div>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedMetric === 'tonnage'): ?>
                    ...
                    <?php elseif($selectedMetric === 'revenue'): ?>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs md:text-sm text-slate-700">
                    ...
                    <?php elseif($selectedMetric === 'ships'): ?>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs md:text-sm text-slate-700">
                ...
                <div style="margin-top: 16px; background: linear-gradient(135deg, #1e293b 0%, #0f172a 100%); color: #ffffff; border-radius: 12px; padding: 14px 18px; display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 10px;">
                    <div style="display: flex; align-items: center; gap: 10px;">
                        ...
                        <div>
                            <strong style="font-size: 0.92rem; display: block;">معامل التشتت الحالي لسنة <?php echo e($d['fiscalYears']->firstWhere('id', $selectedFiscalYearId)?->year); ?>: <?php echo e(number_format($stat['cv'] ?? 0, 1)); ?>% (<?php echo e($stat['stability'] ?? '—'); ?>)</strong>
                            <span style="font-size: 0.78rem; opacity: 0.85;">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(($stat['cv'] ?? 0) <= 15): ?>
                                    الأداء مستقر جداً ومنتظم شهرياً. يُنصح بالحفاظ على معايير التشغيل والتعاقدات الحالية.
                                <?php elseif(($stat['cv'] ?? 0) <= 30): ?>
...
<?php endif; ?>
<?php /**PATH D:\Projects\ports-system\resources\views\filament\pages\standard-deviation-analytics.blade.php ENDPATH**/ ?>