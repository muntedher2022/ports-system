    ...
    <div class="cs-dashboard">
        ...
        <div class="cs-filter-bar">
            ...
            <div class="cs-filter-left">
                ...
                <button
                    ...
                    class="cs-type-btn abandoned <?php echo e($this->selectedCargoType === 'abandoned' ? 'active' : ''); ?>">
                    📦 متخلفة
                </button>
                <button
                    wire:click="$set('selectedCargoType', 'dangerous')"
                    class="cs-type-btn dangerous <?php echo e($this->selectedCargoType === 'dangerous' ? 'active' : ''); ?>">
                    ⚠️ خطرة
                </button>
            ...
            <div class="cs-filter-right">
                <a
                    href="<?php echo e(route('admin.cargo-status.export', [
        ...
        <div class="cs-stats-grid">
            <div class="cs-stat-box" style="border-right: 4px solid #3b82f6;">
                ...
                <div class="cs-stat-value" style="color: #1e40af;"><?php echo e(number_format($d['govTotal'])); ?></div>
                <div style="font-size:0.75rem;color:#94a3b8;margin-top:2px;">
                    <?php echo e($d['grandTotal'] > 0 ? round(($d['govTotal'] / $d['grandTotal']) * 100, 1) . '%' : '0%'); ?> من الإجمالي
                </div>
            </div>

            <div class="cs-stat-box" style="border-right: 4px solid #10b981;">
                <div class="cs-stat-title">🏢 القطاع الخاص</div>
                <div class="cs-stat-value" style="color: #065f46;"><?php echo e(number_format($d['privateTotal'])); ?></div>
                <div style="font-size:0.75rem;color:#94a3b8;margin-top:2px;">
                    <?php echo e($d['grandTotal'] > 0 ? round(($d['privateTotal'] / $d['grandTotal']) * 100, 1) . '%' : '0%'); ?> من الإجمالي
                </div>
            </div>

            <div class="cs-stat-box" style="border-right: 4px solid #f59e0b;">
                <div class="cs-stat-title">📊 إجمالي المواد / الطرود</div>
                <div class="cs-stat-value" style="color: #92400e;"><?php echo e(number_format($d['grandTotal'])); ?></div>
                <div style="font-size:0.75rem;color:#94a3b8;margin-top:2px;">
                    <?php echo e($portName); ?> — شهر <?php echo e($monthLabel); ?>
            ...
            <div class="cs-stat-box" style="border-right: 4px solid #8b5cf6;">
                ...
                <div class="cs-stat-value" style="color: #5b21b6;"><?php echo e(count($entities)); ?></div>
        ...
        <div class="cs-card">
            <div class="cs-card-header">
                <h3>📋 موقف <?php echo e($typeLabel); ?> لغاية شهر <?php echo e($monthLabel); ?> لسنة <?php echo e($yearLabel); ?> — (<?php echo e($portName); ?>)</h3>
            </div>

            <div class="cs-table-wrap">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(empty($entities)): ?>
                    <div class="cs-no-data">
                        ⚠️ لا توجد بيانات لهذا الشهر والسنة — يرجى إدخال البيانات من صفحة <a href="<?php echo e(route('filament.admin.resources.cargo-status-records.index')); ?>" style="color:#2563eb;text-decoration:underline;">سجلات المواد والبضائع</a>
                    </div>
                <?php else: ?>
                <table class="cs-table">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($row['entity']->entity_type === 'government'): ?>
                                <tr class="cs-row-gov">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $years; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $y): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        ...
                                        <td><?php echo e($val > 0 ? number_format($val) : ''); ?></td>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                    <td style="font-weight:800;color:#1e40af;"><?php echo e($row['row_total'] > 0 ? number_format($row['row_total']) : ''); ?></td>
                                </tr>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($row['entity']->entity_type === 'private'): ?>
                                <tr class="cs-row-private">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $years; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $y): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        ...
                                        <td><?php echo e($val > 0 ? number_format($val) : ''); ?></td>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                    <td style="font-weight:800;color:#065f46;"><?php echo e($row['row_total'] > 0 ? number_format($row['row_total']) : ''); ?></td>
                                </tr>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    </tbody>
                    <tfoot>
                        ...
                        <tr class="cs-row-grand-total">
                            <td>المجموع</td>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $years; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $y): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <td><?php echo e(($totalByYear[$y] ?? 0) > 0 ? number_format($totalByYear[$y]) : ''); ?></td>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                            <td><?php echo e(number_format($d['grandTotal'])); ?></td>
                        </tr>
                    </tfoot>
                </table>
...
<?php endif; ?>
<?php /**PATH D:\Projects\ports-system\resources\views/filament/pages/cargo-status-matrix.blade.php ENDPATH**/ ?>